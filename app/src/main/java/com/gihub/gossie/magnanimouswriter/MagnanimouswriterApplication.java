...
public class MagnanimouswriterApplication {
    ...
    public CommandLineRunner initializeData(MovieEntityRepsitory movieEntityRepsitory) {
        return args -> {
            movieEntityRepsitory.save(new MovieEntity("Stirb langsam", "ACTION"));
            movieEntityRepsitory.save(new MovieEntity("Geschenkt ist noch zu teuer", "COMEDY"));
            movieEntityRepsitory.save(new MovieEntity("Bad Boys", "ACTION"));
        };
    }
}
